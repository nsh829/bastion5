...
public class EV3Brick {
	...
	public static void main(String[] args) {
		...
		Behavior b3 = new RushToEnemy();
		Behavior b4 = new stopRushToEnemy();
...
class TurnAround implements Behavior {
	...
	@Override
	public void action() {
		if(EV3Brick.sonar.getDistance() < 30 || EV3Brick.rushing == true || EV3Brick.goBackToStadium == false) EV3Brick.wheel.goFront();
		else EV3Brick.wheel.keepTurn();
	}
